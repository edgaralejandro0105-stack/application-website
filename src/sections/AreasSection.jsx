    ...
    <section id="zonas" className="py-24 bg-background relative z-10">
      <div className="max-w-[1200px] mx-auto px-6 md:px-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          {areas.map(area => (
            <Card key={area.id} className="bg-surface-container-low/30 border-white/5 flex flex-col h-full hover:-translate-y-1 transition-transform duration-300 group">
