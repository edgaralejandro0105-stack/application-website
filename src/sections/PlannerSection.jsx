            ...
            {step === 3 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="font-jakarta text-on-surface-variant max-w-md mx-auto mb-8 leading-relaxed">
                  Tu solicitud ha sido guardada en nuestra base de datos. Para asegurar tu reserva más rápido, por favor <strong>envíanos el mensaje de confirmación</strong> por WhatsApp.
                </p>
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Button 
                    variant="primary" 
                    className="bg-[#25D366] hover:bg-[#20b858] text-white border-none flex items-center gap-2"
                    onClick={() => {
